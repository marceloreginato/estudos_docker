...
Se uma aplicação apresenta problema, é possível simplesmente **parar (ou matar) o container**, sem impactar o restante do sistema. Além disso, cada container pode ter sua cprópria versão de dependências, o que elimina conflitos.
