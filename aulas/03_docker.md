...
- Docker Client
É a interface utilizada pelo usuário (linha de comando).

- Docker Daemon (dockerd)
É o principal componente do Docker (API do docker), responsável por executar e gerenciar todas as operações.
Responsável por:
